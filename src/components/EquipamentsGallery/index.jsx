      ...
      <Container>
        <Cube $backgroundImage={desktops}>
          <CubeContent>
            ...
            <CubeImage style={{width: "120px", height: "auto", marginLeft: "8px"}} src={work} alt="Workstation" />
          </CubeContent>
        </Cube>
        <Cube $backgroundImage={monitors}>
          <CubeContent>
            <Text>Monitores</Text>
            <CubeImage style={{width: "140px", height: "140px", marginLeft: "8px"}} src={screen} alt="Screen" />
          </CubeContent>
        </Cube>
